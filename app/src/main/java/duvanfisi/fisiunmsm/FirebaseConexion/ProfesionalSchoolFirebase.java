...
public class ProfesionalSchoolFirebase {

    private Context context;
    private FirebaseDatabase firebaseDatabase;
    private DatabaseReference databaseReference;

    private CFaculty faculty;
    private ArrayList<CEscuela> escuelas;


    public ProfesionalSchoolFirebase(Context context){
    ...
    public void setCollectionFacultades(String cod, final TextView title_fac, final ImageView imageView,
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                faculty = dataSnapshot.getValue(CFaculty.class);

                if(faculty!=null){
                    title_fac.setText(faculty.getNombre());

                    ProfessionalSchoolActivity.FACULTY_SELECTED = faculty.getNombre();
                    ImagePicasso.setImageCenterInside(context, faculty.getPhoto(), imageView);
                    ...
                    databaseReference.child(Utilidades.ESCUELAS).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            ProfessionalSchoolActivity.dialog_loading.dismiss();
                        }
