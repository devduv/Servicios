...
public class NicknameActivity extends AppCompatActivity {
    ...
    public void userActivo() {
        ...
        user= (CStudent) intent.getExtras().get(Utilidades.KEY_MODEL_USER);
    }
        ...
        final AsyncTask<String, String, String> download = new AsyncTask<String, String, String>() {
            ...
            protected void onPostExecute(String s) {
                if(s.equals("registrado")){
                    ...
                    register_nick_model();
                    register_nick_database();
                    FirebaseAccount.gotoMain(NicknameActivity.this, firebaseUser, user);
                }
            }
        };
    ...
    public void register_nick_model(){
        user.setNick(nickname);
        user.setPhoto(photo_link);
        user.setColor(color);
    }
    public void register_nick_database(){
        FirebaseDatabase firebaseDatabase = new FirebaseDatabase(this);
        UserFirebase userFirebase = new UserFirebase(firebaseDatabase);

        userFirebase.setNickname(nickname, photo_link, color, firebaseUser);
    }
